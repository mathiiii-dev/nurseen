                    ...
                    <div className="embla__container">
                        <div className="embla__slide">
                            <DashboardCard
                                ...
                                text={
                                    "Ajouter vos enfant pour qu'ils soient liés à leur nourrice. Code nourrice nécessaire"
                                }
                        ...
                        <div className="embla__slide">
                            <DashboardCard
                                ...
                                text={
                                    'Votre nourrice peut ajouter ici des photos en vrac de tout les enfants'
                                }
                        ...
                        <div className="embla__slide">
                            <DashboardCard
                                ...
                                text={
                                    'Votre nourrice peut ajouter ici le menu du jour'
                                }
                        ...
                        <div className="embla__slide">
                            <DashboardCard
                                ...
                                buttonText={'Chat'}
                                text={
                                    'Voir les messages envoyez par votre nourrice. Envoyez des messages'
                                }
                        ...
                        <div className="embla__slide">
                            <DashboardCard
                                ...
                                text={
                                    'Envoyez des fichiers à votre nourrice. Voir vos fichiers'
                                }
