            ...
            <tr key={element.id}>
                ...
                <td>
                    {element.activated ? (
                        <Button
                            color="red"
                            onClick={() => activate(element.id, false)}
                        >
                            Désactiver
                        </Button>
                    ) : (
                        <Button
                            ...
                            onClick={() => activate(element.id, true)}
                        >
                            Activer
                        </Button>
                    )}
                    ...
                    <div className="embla__container">
                        <div className="embla__slide">
                            <DashboardCard
                                ...
                                text={
                                    'Créer un code de liaison pour que un parent enregistre un enfant'
                                }
                        ...
                        <div className="embla__slide">
                            <DashboardCard
                                ...
                                text={
                                    'Gérez votre emploie du temps grace au calendrier et les jours de présence des enfants'
                                }
                                linkHref={'nurse/calendar'}
                            />
                        </div>
                        <div className="embla__slide">
                            <DashboardCard
                                ...
                                text={
                                    "Ajouter une note sur la journée de l'enfant. Elle sera ensuite visible par ses parents"
                                }
                                linkHref={'nurse/note'}
                            />
                        </div>
                        <div className="embla__slide">
                            <DashboardCard
                                ...
                                text={
                                    'Ajouter des photos des enfants en vrac. Elles serront visibles par les parents'
                                }
                        ...
                        <div className="embla__slide">
                            <DashboardCard
                                ...
                                text={
                                    'Ajouter un menu du jour. Il sera visible par les parents'
                                }
                                linkHref={'nurse/menu'}
                            />
                        </div>
                        <div className="embla__slide">
                            <DashboardCard
                                ...
                                buttonText={'Chat'}
                                text={
                                    'Engagez des discutions avec les parents, Répondez a leurs messages'
                                }
                                linkHref={'nurse/chat'}
                            />
                        </div>
                        <div className="embla__slide">
                            <DashboardCard
                                ...
                                text={
                                    'Envoyez des fichiers au parents. Voir les fichiers envoyez par les parents'
                                }
                                linkHref={'nurse/file'}
                            />
                        </div>
