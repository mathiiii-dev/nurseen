...
import {Accordion, Button, Group, Space, Text, Title, Modal, Center, Drawer} from "@mantine/core";
    ...
    return (
        <>
            ...
            >
                {
                    <form onSubmit={update}>
                        ...
                        <Button type="submit" size={"md"}
                                ...
                                disabled={rejected}>Envoyez</Button>
                    </form>
                }
            </Drawer>
            <Modal
            ...
            <form onSubmit={send}>
                ...
                <Space h={"xl"}/>
                <Button type="submit" size={"md"}
                        style={{backgroundColor: '#4ad4c6', float: 'right'}} disabled={rejected}>Envoyez</Button>
            </form>
            <Space h={"xl"}/>
            <Space h={"xl"}/>
            <Space h={"xl"}/>
